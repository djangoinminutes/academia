...
from .views import homeView, CursoListView, CursoCreateView, CursoUpdateView, CursoDeleteView, CursoDetailView
...
visitante_patterns = ([
	...
	path('NuevoCurso/', CursoCreateView.as_view(),name='nuevoCurso'),
